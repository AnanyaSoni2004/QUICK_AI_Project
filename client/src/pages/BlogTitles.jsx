...
//                             className={`text-xs px-4 py-1 border rounded-full cursor-pointer ${selectedCategory === item ? 'bg-purple-50 text-blue-700' : 'text-gray-500 border-gray-300'}`}
//                         >
//                             {item}
//                         </span>
//                     ))}
                    ...
                    {blogCategories.map((item) => (
                        <span
                            ...
                            className={`text-xs px-4 py-1 border rounded-full cursor-pointer ${
                                selectedCategory === item ? 'bg-purple-50 text-blue-700' : 'text-gray-500 border-gray-300'
                            }`}
                        >
                            {item}
                        </span>
